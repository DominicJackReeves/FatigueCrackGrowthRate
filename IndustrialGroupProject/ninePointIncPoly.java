public class ninePointIncPoly	{
	private double ar;
	private double dadn;
	private double x;
	private double deltaK;
	public ninePointIncPoly(){}
	public ninePointIncPoly(double[] a, double[] N, double deltaP)	{
		...
		double Denom = 9*Term1-sx*Term2+sx2*Term3;
		...
		double Numer3= 9*Term4 - sx*Term5 +sx2 * Term6;
		...
		double Numer4= 9*Term7 - sx*Term8 +sx2 * Term9;
		...
		//dadn is da/dN
		//double r2 = 1- rss/tss;
		dadn = bb2/c2 + 2*bb3*(N[8]-c1)/(c2*c2);
		x = (N[4]-c1)/c2;
